    ...
    <div class="container-fluid border" style="height: 100vh;">
        <div class="row" style="height: 100%;">
            <div class="col-3 border py-3">
                <h2 style="font-family: 'MuseoModerno', cursive;" class="mb-3">Registrasi</h2>
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <p class="text-center" style="display: block;">Sudah punya akun? <a href="login.php">Klik disini!</a></p>
                </form>
            </div>
            <div class="col border text-center py-5">
                <h1 class="mt-5 font-weight-bold" style="font-family: 'Ubuntu', sans-serif; font-size:30px;">Selamat Datang!</h1>
                <h1 class="mt-4" style="font-family: 'Ubuntu', sans-serif;">di Website</h1>
                <h1 class="mb-5" style="font-family: 'Ubuntu', sans-serif;">Data Mahasiswa UPB Bojongmangu</h1>
